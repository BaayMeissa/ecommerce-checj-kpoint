                ...
                cartData.map((item,index)=>{
                    ...
                    return (
                        <div className='py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4' key={index}>
                            <div className='flex items-start gap-6'>
                                ...
                                <div>
                                    ...
                                    <div className='flex items-center gap-5 mt-2'>
                                        ...
                                        <p className='px-2 sm:px-3 bg-slate-50 sm:py-1 border'>
                                            {item.size}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <img onClick={()=>updateQuantity(item._id, item.size,0)} src={assets.bin_icon} className='w-4 cursor-pointer sm:w-5 mr-4' alt="" />
                        </div>
                    )
                })
            }
